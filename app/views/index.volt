...
<html>
    <head>
        ...
        {{ stylesheet_link('plugins/radioslider/radios-to-slider.css') }}
        {{ stylesheet_link('dist/semantic.min.css') }}
        {{ stylesheet_link('css/main.css') }} 
        {{ stylesheet_link('plugins/pacejs/pace.css') }}
    ...
    <body class="admin">            
        ...
        {{ javascript_include('plugins/nicescrool/jquery.nicescroll.min.js') }}
        {{ javascript_include('dist/semantic.min.js') }}
        {{ javascript_include('plugins/radioslider/jquery.radios-to-slider.js') }}
